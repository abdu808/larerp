...
## وثائق القرار والمنتج

- [الوثيقة المرجعية لبناء منصة ERP للجمعيات](charity-erp-platform-blueprint-ar.md)
- [مصفوفة تنفيذ الموديولات](module-implementation-matrix-ar.md)
- [خارطة التنفيذ](ROADMAP-ar.md)

## الهندسة

- [مسودة تصميم قاعدة البيانات](architecture/database-schema-draft-ar.md)

## مسارات العمل

- [Platform Foundation](workstreams/foundation-workstream-ar.md)
- [Beneficiaries and Social Care](workstreams/social-care-workstream-ar.md)
...
- [قواعد قبول عمل الوكلاء والموديولات](operations/module-acceptance-rules-ar.md)
