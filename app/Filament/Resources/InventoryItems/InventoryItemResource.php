...
class InventoryItemResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'صنف مخزون';

    protected static ?string $pluralModelLabel = 'أصناف المخزون';

    protected static ?string $navigationLabel = 'أصناف المخزون';
